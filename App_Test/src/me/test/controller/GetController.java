...
public class GetController extends HttpServlet {
    ...
    private Logger logger = Logger.getLogger(GetController.class);
    private String GET_URL = "http://localhost:6969/get?from=";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
        try {
            ...
            HttpGet httpGet = new HttpGet(GET_URL + from + "&to=" + to);
