 ...
 */
public class InputInsertController extends HttpServlet{
    private Logger logger = Logger.getLogger(InputInsertController.class);
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp){
        try {
            TemplateDataDictionary myDic = TemplateDictionary.create();
            myDic.setVariable("path", EsaleFEConfig.path);
            String template = Utils.renderTemplate("Template/insert.html", myDic);
